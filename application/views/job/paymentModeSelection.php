        ...
        <div class="panel">
            <div class="row widget-row-in">
                <div class="col-md-12 card service-card" style="padding:10px; text-align:center; margin:auto;">
                    ...
                    <div style="background-color: #fff; border: 1px solid #ddd; border-radius: 8px; box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1); width: 300px; margin: 10px; padding: 20px; display: inline-block; vertical-align: top;">
                        <h3 style="margin: 0 0 10px; font-size: 18px; color: #333;">2. Debit Card</h3>
                        <br>
                        <br>
                        <?php
...
<form id="autoSubmitForm" method="post" action="<?= htmlspecialchars($url) ?>">
    ...
    ?>
    <p style="margin: 5px 0; color: #555;">Pay securely using your debit card through our payment gateway.</p>
    <br>
    <?php if ($jobApplication['payment_mode'] != 'Card Payment' && $jobApplication['payment_mode'] != 'JazzCash Wallet' && $jobApplication['payment_mode'] != 'MP' ){ ?>
                        
    <button type="submit" style="background-color: #008CBA; color: white; border: none; border-radius: 5px; padding: 10px 20px; margin-top: 10px; cursor: pointer;">Pay with Debit Card</button>
    <?php } ?>
</form>
                    ...
                    <div style="background-color: #fff; border: 1px solid #ddd; border-radius: 8px; box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1); width: 300px; margin: 10px; padding: 20px; display: inline-block; vertical-align: top;">
                        <h3 style="margin: 0 0 10px; font-size: 18px; color: #333;">3. Pay & Upload Screenshot</h3>
