	...
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li class="<?=(empty($validation_error) ? 'active' : '') ?>">
				<a href="#list" data-toggle="tab"><i class="fas fa-list-ul"></i> Status List</a>
			</li>
			<li class="<?=(!empty($validation_error) ? 'active' : '') ?>">
				<a href="#create" data-toggle="tab"><i class="far fa-edit"></i> Create Status</a>
			</li>
		</ul>
					...
					<table class="table table-bordered table-hover table-condensed mb-none table-export">
						...
						<tbody>
							...
							<tr>
								...
								<td class="min-w-c">
									<!--update link-->
									<a href="<?=base_url('status/edit/'.$status->id)?>" class="btn btn-default btn-circle icon">
										<i class="fas fa-pen-nib"></i>
									</a>
									<!-- delete link -->
									<?php echo btn_delete('status/delete_data/' . $status->id);?>
								</td>
							</tr>
							<?php endforeach; ?>
						</tbody>
