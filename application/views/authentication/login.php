...
<head>
        ...
        <div class="auth-main">
            <div class="container">
                <div class="slideIn">
                    ...
                    <div class="col-lg-1 col-lg-offset-1 col-md-4 col-md-offset-1 col-sm-12 col-xs-12 no-padding fitxt-center">
                        
                    </div>

                    <!-- Login -->
                    <div class="col-lg-8 col-lg-offset-right-1 col-md-6 col-md-offset-right-1 col-sm-12 col-xs-12 no-padding">
                        <div class="sign-area">
                            <div class="sign-hader">
                                 <img src="<?php echo base_url('uploads/app_image/text-logo.png');?>" height="80" width="200">
                            </div>
                            <?php echo form_open($this->uri->uri_string()); ?>
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <a href="<?php echo base_url('/register');?>" class="btn btn-block btn-success btn-1" style="background-color: #3c763d;
	border-color: #fff;
	...
	box-shadow: 2px 3px 6px #2c2c2c;">
                                ...
                                <div class="text-center">
                                    <a href="<?php echo base_url('/home');?>"><i class="fas fa-long-arrow-alt-left"></i>Go Back</a>
                                </div>
                                
        
                                    <center><p><?php echo $global_config['footer_text'];?></p><center>
