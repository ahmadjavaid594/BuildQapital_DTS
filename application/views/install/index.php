...
<head>
	...
	<body>
		<div class="container pmx">
                ...
                <div class="tabs-custom">
                    ...
                    <div class="tab-content">
                        ...
                        <?php elseif ($step == 4) : ?>
                            <?php echo form_open($this->uri->uri_string(), array('class' => 'form-horizontal form-bordered validate')); ?>
								<div class="form-group">
									<label class="col-md-3 control-label">Institute <span class="required">*</span></label>
									<div class="col-md-9">
										<input type="text" class="form-control" name="school_name" placeholder="Institute" value="<?=set_value('school_name')?>" />
            ...
            <center> 2020 © All Rights Reserved - <a href="about:blank">dts</a></center>
		</div>
