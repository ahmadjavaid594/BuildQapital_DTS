    ...
    public function index()
    {
        //if (is_superadmin_loggedin()) {
          /*  if ($this->input->post('submit') == 'save') {
            ...
            $syllabuses = $this->job_model->getJobsSyllabus();
            $this->data['syllabuses'] = $syllabuses;
            $this->data['title'] = 'Test Syllabus';
            $this->data['sub_page'] = 'syllabus/add';
            $this->data['main_menu'] = 'syllabus';
